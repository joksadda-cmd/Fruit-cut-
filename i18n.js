...
(function () {
    ...
    var DICTIONARY = [
        ...
        ["🏆 Weekly Competition","🏆 সাপ্তাহিক প্রতিযোগিতা","🏆 Еженедельное соревнование","🏆 साप्ताहिक प्रतियोगिता","🏆 Haftalık Yarışma","🏆 Competencia Semanal","🏆 المسابقة الأسبوعية","🏆 Kompetisi Mingguan"],
        ["🔪 Slash","🔪 স্ল্যাশ","🔪 Слэш","🔪 स्लैश","🔪 Dilimle","🔪 Cortar","🔪 التقطيع","🔪 Potong"],
        ["👥 Refer","👥 রেফার","👥 Рефералы","👥 रेफर","👥 Davet Et","👥 Referir","👥 الإحالة","👥 Rujuk"],
        ["No slashes recorded yet this week.","এই সপ্তাহে এখনও কোনো স্ল্যাশ রেকর্ড হয়নি।","На этой неделе пока нет резов.","इस हफ्ते अभी तक कोई स्लैश दर्ज नहीं हुआ है।","Bu hafta henüz dilimleme kaydedilmedi.","Aún no se ha registrado ningún corte esta semana.","لم يتم تسجيل أي تقطيع هذا الأسبوع بعد.","Belum ada potongan tercatat minggu ini."],
        ["No referrals recorded yet this week.","এই সপ্তাহে এখনও কোনো রেফারেল রেকর্ড হয়নি।","На этой неделе пока нет рефералов.","इस हफ्ते अभी तक कोई रेफरल दर्ज नहीं हुआ है।","Bu hafta henüz davet kaydedilmedi.","Aún no se ha registrado ninguna referencia esta semana.","لم يتم تسجيل أي إحالة هذا الأسبوع بعد.","Belum ada rujukan tercatat minggu ini."],
